...
// An alternative version of HEAD, with less CSS, and no included font.
// TODO: Allow users to choose this alternative version in the configuration.
//const HEADSPL: &str = r"<!DOCTYPE HTML><meta content='width=device-width,initial-scale=1,minimum-scale=1,maximum-scale=1' name=viewport><style>body *{margin:0;font:300 32px sans-serif;color:#404040;text-decoration:none}h1{margin:.2em 0;font-size:60px}svg{height:60px;position:relative}h1 svg{top:8px;right:5px}a svg{height:32px;top:6px;right:6px}.ok{color:#20b48c;fill:#20b48c}.err{color:#b42020;fill:#b42020}span{color:#828282;font-size:24px}body{margin:30px 40px}.bottom,.btmright{display:none}th{text-align:left}td:nth-child(even){width:50px}td:nth-child(odd){width:400px}.btmright{padding:.3em 0}@media all and (max-width:600px){td:nth-child(even){display:none}}</style>";
